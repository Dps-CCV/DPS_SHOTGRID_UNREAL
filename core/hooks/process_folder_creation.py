            ...
            for i in items:
                ...
                if action in ["entity_folder", "folder"]:
                    ...
                    if not os.path.exists(path):
                        # if i.get("metadata")["server"] == "escritura":
                        #     command = "C:\Windows\System32\powershell.exe New-DfsnFolder -Path " + path + " -TargetPath " + "\\\\magma\\proyectos\\Contoso-FS\\AccountingLegacy" + " -EnableTargetFailback $True"
