...
module: shotgrid_fields_config_B
{
...
function: serverMap (string; )
{
    ...
    //
    //  return "https://site1.shotgridstudio.com 4b1676497a208c845b12f5c6734daf9d6e7c6274 http://site2.shotgridstudio.com 4b1676497a208c845b12f5c6734daf9d6e7c6274"
    //
...
function: fieldDescriptors((string, string, string, string, string, bool)[]; )
{
    ...
    //
    // name                prettyName       fieldName             fieldType      entityType compute
    ("mt_Movie",           "Path To Movie", "sg_shotgrid_path",   "text",        "Element", false),
